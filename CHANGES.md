...
- Transitioned Dockerfile.tests to use uv sync for strict lockfile adherence in local development. ([#389](https://github.com/stac-utils/stac-fastapi-pgstac/pull/389))
